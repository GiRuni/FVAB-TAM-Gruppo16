...
DEFAULT_CAPTIONS_JSON = Path(r"/content/FVAB-TAM-L-haMburger/Fase_0/tam-logit-lenses/ll_tam/instances_minival2014.json")
DEFAULT_INSTANCES_JSON = Path(r"/content/FVAB-TAM-L-haMburger/Fase_0/tam-logit-lenses/ll_tam/data/coco2014/annotations/instances_minival2014.json")
